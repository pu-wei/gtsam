...
if(EXISTS "${OUR_CMAKE_DIR}/CMakeCache.txt")
  # In build tree
  set(GTSAM_INCLUDE_DIR /Users/wpu/Documents/gtsam CACHE PATH "GTSAM include directory")
else()
...
find_package(Boost 1.58 COMPONENTS serialization;system;filesystem;thread;program_options;date_time;timer;chrono;regex)
else()
find_dependency(Boost 1.58 COMPONENTS serialization;system;filesystem;thread;program_options;date_time;timer;chrono;regex)
endif()
